package com.moon.applicationEvent;
...
public class ApplicationEventAspect {
	...
	@Pointcut("execution(* com.moon.web.controller.system.SysLoginController.ajaxLogin(..))")
	public void afterLoginPointcut() {
	}

	@Pointcut("execution(* com.moon.quartz.controller.SysJobController.run(..))")
