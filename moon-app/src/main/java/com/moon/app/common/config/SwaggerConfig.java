package com.moon.app.common.config;
...
public class SwaggerConfig
{
    ...
    public Docket createRestApi()
    {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                // 指定当前包路径
                // .apis(RequestHandlerSelectors.basePackage("com.moon.web.controller.tool"))
                // .apis(basePackage("com.moon.web.controller.system,com.moon.web.controller.tool"))
